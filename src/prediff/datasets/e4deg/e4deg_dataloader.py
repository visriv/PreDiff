...
# sevir-lr
SEVIR_LR_CATALOG = os.path.join(default_dataset_sevirlr_dir, "CATALOG.csv")
SEVIR_LR_DATA_DIR = os.path.join(default_dataset_sevirlr_dir, "data")
