...
pytorch_state_dict_name = "kol_vae.pt"
pytorch_loss_state_dict_name = "kol_vae_loss.pt"


class VAEkolPLModule(pl.LightningModule):
    ...
    def __init__(self,
                 ...
                 oc_file: str = None,
                 save_dir: str = None):
        super(VAEkolPLModule, self).__init__()
    ...
    def save_vis_step_end(
        ...
        if self.local_rank == 0:
            ...
            if data_idx in example_data_idx_list:
                ...
                vis_kol_custom(save_path=os.path.join(self.example_save_dir, save_name),
                    seq=seq_list,
                    label=label_list,)
...
def main():
    ...
    if args.pretrained:
        args.cfg = os.path.abspath(os.path.join(os.path.dirname(__file__), "vae_kol_v1.yaml"))
    ...
    if args.cfg is not None:
        ...
        dataset_cfg = OmegaConf.to_object(VAEkolPLModule.get_dataset_config())
        micro_batch_size = 1
    ...
    dm = VAEkolPLModule.get_kol_datamodule(
    ...
    total_num_steps = VAEkolPLModule.get_total_num_steps(
        epoch=max_epochs,
        num_samples=dm.num_train_samples,
        total_batch_size=total_batch_size,
    )
    print('Total num of steps:', total_num_steps)
    pl_module = VAEkolPLModule(
